    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <main className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto">
          Create polls, predict outcomes, and earn rewards. Powered by Ethereum smart contracts for ultimate transparency and security.
        </p>
        ...
        <div className="mt-20">
          <h2 className="text-3xl font-bold mb-8">Or Create a Poll Right Now</h2>
          <CreatePoll />
        </div>
